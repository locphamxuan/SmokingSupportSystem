  ...
  return (
    <div className="about-page">
      ...
      <div className="harmful-effects-image-container">
        <img src={harmEffectsImage} alt="Understanding smoking effects" className="harmful-effects-image" />
      </div>
      ...
      <div className="post-quit-image-container">
        <img src={postQuitImage} alt="Man happy after quitting smoking" className="post-quit-image" />
      </div>
      ...
      <section className="steps">
        <div className="container">
          ...
          <p className="section-description">Lộ trình cai nghiện thuốc lá từng bước, giúp bạn dễ dàng đạt được mục tiêu.</p>
          <div className="steps-grid">
            ...
            <div className="step-card">
              <div className="step-icon"><i className="fas fa-people-carry"></i></div>
              <h3>Tìm kiếm sự hỗ trợ</h3>
              <p>Tham gia cộng đồng hỗ trợ, tìm kiếm sự giúp đỡ từ gia đình và bạn bè.</p>
            </div>
            <div className="step-card">
              <div className="step-icon"><i className="fas fa-hand-holding-heart"></i></div>
      ...
      <section className="faq">
        <div className="container">
          ...
          <p className="section-description">Giải đáp các thắc mắc về quá trình cai nghiện thuốc lá.</p>
          <div className="faq-grid">
            <div className="faq-item">
              <div className="faq-icon"><i className="fas fa-question"></i></div>
        ...
        <div className="container">
          <div className="community-content-wrapper">
            <div className="community-image-card">
              <img src={communityImage} alt="Community support for quitting smoking" />
            </div>
            <div className="community-text-content">
              <h2>Tham gia cộng đồng hỗ trợ</h2>
              <p>Kết nối với những người đang cai nghiện thuốc lá và chia sẻ kinh nghiệm.</p>
              <div className="community-benefits">
                <ul>
                  <li><i className="fas fa-check-circle"></i> Nhận sự hỗ trợ và động viên</li>
                  <li><i className="fas fa-check-circle"></i> Tìm kiếm lời khuyên từ chuyên gia</li>
                </ul>
                <ul>
                  <li><i className="fas fa-check-circle"></i> Chia sẻ kinh nghiệm và học hỏi</li>
      ...
      <section className="articles-section">
        <div className="container">
          <div className="articles-header">
            ...
            <Link to="/blog" className="see-more-btn">Xem thêm <i className="fas fa-arrow-right"></i></Link>
          </div>
          <div className="articles-grid">
            <div className="article-card">
              <a href="https://vnexpress.net/hai-bien-phap-giup-giam-tac-hai-cua-khoi-thuoc-4719531.html" target="_blank" rel="noopener noreferrer">
            ...
            <div className="article-card">
              <a href="https://baolongan.vn/giai-phap-nao-de-tu-bo-su-dung-thuoc-la-the-he-moi-a196851.html" target="_blank" rel="noopener noreferrer">
            ...
            <div className="article-card">
              <a href="https://www.phoiviet.com/new/153/loi-ich-truoc-mat-va-lau-dai-cua-viec-cai-thuoc-la.html" target="_blank" rel="noopener noreferrer">
            ...
            <div className="article-card">
              <a href="https://trungtamytebinhtan.medinet.gov.vn/phong-chong-tac-hai-thuoc-la/co-the-thay-doi-the-nao-neu-bo-thuoc-la-trong-mot-nam-cmobile16833-142046.aspx" target="_blank" rel="noopener noreferrer">
