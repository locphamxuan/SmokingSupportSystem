    ...
    return (
      <div className="container py-4 mt-5">
        ...
        <div className="text-center">
          <button className="btn btn-outline-primary mt-3" onClick={handleBack}>&larr; Quay lại</button>
        </div>
      </div>
    );
  }
    ...
    <div className="container py-4 px-2 mt-5">
      <div className="chat-container">
        ...
        <div className="chat-header mb-3 d-flex align-items-center">
          ...
          <div className="avatar bg-success text-white me-2 d-flex align-items-center justify-content-center" style={{ width: 35, height: 35, borderRadius: '50%' }}>
            {memberData?.Username?.charAt(0)?.toUpperCase()}
          </div>
          <div>
            <div className="fw-bold text-primary">{memberData?.Username || `Thành viên #${memberId}`}</div>
          ...
          {messages.length === 0 ? (
            <div className="d-flex justify-content-center align-items-center h-100">
              <div className="text-center text-muted">
                ...
                <div className="small">Hãy bắt đầu cuộc trò chuyện với thành viên này!</div>
              </div>
            </div>
          ) : (
            <div>
