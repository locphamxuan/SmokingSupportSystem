...
const AchievementsPage = () => {
  ...
  useEffect(() => {
    const fetchBadgesData = async () => {
      try {
        ...
        console.log(
          "AchievementsPage - Fetched user badges:",
          userBadgesResponse.badges,
        );
        console.log(
          "AchievementsPage - Fetched all badges:",
          allBadgesResponse.badges,
        );
  ...
  const isUserBadge = (badgeId) =>
    userBadges.some((b) => Number(b.BadgeId || b.Id) === Number(badgeId));
  const getUserBadgeInfo = (badgeId) =>
    userBadges.find((b) => Number(b.BadgeId || b.Id) === Number(badgeId));
    ...
    <div className="container achievements-bootstrap-page py-5">
      <div className="text-center mb-5">
        ...
        <p className="lead text-secondary">
          Theo dõi hành trình và các mốc quan trọng bạn đã đạt được
        </p>
      ...
      <div className="row g-4 justify-content-center">
        {allBadges.map((badge) => {
          ...
          const badgeImage =
            badgeImages[badge.BadgeType] || badgeImages["loai1"];
          ...
          return (
            ...
            >
              <div
                className={`card w-100 shadow-sm h-100 border-0 ${earned ? "badge-earned" : "badge-locked"} position-relative`}
              >
                <div className="card-body d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <img
                      ...
                      style={{
                        ...
                        filter: !earned
                          ...
                          : "none",
                        borderRadius: 12,
                        boxShadow: earned ? "0 0 12px #28a74555" : "none",
                      }}
                    />
                    {!earned && (
                      <span
                  ...
                  <h5
                    className={`card-title fw-bold mb-2 ${earned ? "text-success" : "text-muted"}`}
                  >
                    {badge.Name}
                  </h5>
                  <p className="card-text small mb-2 text-secondary">
                    {badge.Description}
                  </p>
                  <span
                    className={`badge ${earned ? "bg-success" : "bg-warning text-dark"} mb-2`}
                  >
