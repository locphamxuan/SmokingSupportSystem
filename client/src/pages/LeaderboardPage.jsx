          ...
          <div className="row text-center text-md-start">
            <div className="col-12 col-md-3 mb-4 mb-md-0">
              ...
              <p className="mb-0 small">
                Hỗ trợ cai nghiện thuốc lá là sứ mệnh của chúng tôi. Chúng tôi
                cam kết đồng hành cùng bạn trên hành trình hướng tới một cuộc
                sống khỏe mạnh hơn.
              </p>
            </div>
            <div className="col-12 col-md-3 mb-4 mb-md-0">
            ...
            <div className="col-12 col-md-3">
              ...
              <ul className="list-unstyled small mb-0">
                ...
                <li>
                  <i className="bi bi-clock-fill me-2 text-success"></i>Hỗ trợ
                  24/7
                </li>
              </ul>
            </div>
          ...
          <div className="row justify-content-center mb-3">
            <div className="col-auto">
              <div className="footer-hotline d-flex align-items-center rounded-pill px-4 py-3 mx-auto">
                ...
                <span>
                  Gọi ngay:{" "}
                  <span className="text-success fw-bold">1800-xxxx</span>
                </span>
              </div>
            </div>
          </div>
